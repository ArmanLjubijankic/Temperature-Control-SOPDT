...
This repository contains Arduino and Python code I wrote to do a temperature control project. The goal was to use PID control to heat a thin graphite slab to 115 F and maintain it. One of the Arduino files uses an on/off controller for the 
